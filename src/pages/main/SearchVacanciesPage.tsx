...
export const SearchVacanciesPage = () => {
    ...
    >
        ...
        <Input className={'SearchInput'}
               ...
               rightSection={
                   <Button radius="md" fw={500} lh={'21px'} loading={isLoading} loaderPosition="center" >Поиск</Button>
               }
        ...
        {data?.objects.map(object =>
            ...
            <Card key={object.id} data-elem={`vacancy-${object.id}`} shadow="sm" padding="xl" radius="12px" mt={16}
