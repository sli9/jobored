import {Card, Group, Input, Loader, Text} from "@mantine/core";
...
export const SearchVacanciesPage = () => {
    ...
    return <>
        ...
        {isLoading && <Loader size='xl' className={'.App-loader'}/>}

        {data?.objects.map(object =>

            <Card key={object.id} data-elem={`vacancy-${object.id}`} shadow="sm" padding="lg" radius="md" withBorder>
                <Group position="apart" mt="md" mb="xs">
                    ...
                    <Text size="sm">
                        ...
                        <span className={'Dot'}>•</span> {object.type_of_work.title}
                    </Text>
